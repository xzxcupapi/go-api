...
func createCustomer(c *gin.Context) {
	...
	query := "INSERT INTO customer (namacust, nohp) VALUES ($1, $2) RETURNING custid"
	...
	err = stmt.QueryRow(customer.NamaCust, customer.NoHP).Scan(&customer.CustId)
	if err != nil {
...
// 	err = row.Scan(&customer.custID, &customer.NamaCust, &customer.NoHP)
// 	if err != nil {
...
// 		fmt.Printf("Error scanning row data: %v\n", err)

// 		// Return a more informative error response
// 		c.JSON(http.StatusInternalServerError, gin.H{"error": "Error fetching customer data", "detail_error": err.Error()})
// 		return
// 	}
...
// 		updatedCustomer.NamaCust, updatedCustomer.NoHP, customerID)
// 	if err != nil {
